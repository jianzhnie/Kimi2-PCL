...
# ckpt_path="/llm_workspace_1P/robin/hfhub/pcl-kimi2"
ckpt_path="/llm_workspace_1P/robin/hfhub/pcl-kimi2/kimi2-hf2mcore7"
...
python /llm_workspace_1P/robin/Kimi2-PCL/utils/get_mcore_weights_from_ckpt.py \
    ...
    --output $SAVE_DIR/model_param_mapping_7.json
